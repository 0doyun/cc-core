...
핵심 수치 한 장으로 말하면, Claude Opus 4.6 의 output 토큰이 **약 $25/M** ([Anthropic 모델 가격표](https://docs.anthropic.com/en/docs/about-claude/models/overview) 기준), DeepSeek V3 계열이 **약 $1–2/M** 입니다. 같은 output 양에 **10 배 이상** 차이가 날 수 있어요. 백그라운드 작업을 저가 모델로 돌리면 월간 비용이 체감될 정도로 빠집니다.
...
- [LiteLLM — Proxy Quick Start](https://docs.litellm.ai/docs/proxy/quick_start) — LiteLLM 프록시 세팅
...
- claude-code-router 커뮤니티 이슈 (DeepSeek tool calling 관련 다수 보고)
