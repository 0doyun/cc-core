...
완성되면 스크린샷을 찍어서 DESIGN.md 와 비교하고, 차이가 있으면 수정해.
```

[공식 Best Practices](https://code.claude.com/docs/en/best-practices) 가 강조하는 핵심: **"Claude 에게 작업을 검증할 방법을 주세요. 이것이 가장 레버리지가 큰 한 가지입니다."** 스크린샷 비교가 그 방법이에요.
...
<Callout type="info">
**Last verified: 2026-04-13** — Figma MCP 리모트 서버 무료 베타, shadcn CLI 3.0 기준.
</Callout>
